...
export const CanvasNode = React.memo(function CanvasNode({
  ...
  const handleResizeUp = useCallback(function onResizeUp() {
...
function VideoNodeContent({ node, theme }: NodeContentRendererProps) {
  const { t } = useInfiniteCanvasTranslation();
  const previewSrc = useCanvasMediaSrc(node.metadata?.content);
...
function ImageContent({
  ...
  const primaryPreview = useCanvasMediaSrc(primaryContent);
...
function ExpandedImageCard({
  ...
  const imagePreview = useCanvasMediaSrc(image.content);
