  ...
  return (
    <g>
      {isCurrentMusicResult && (
        <path
          data-current-music-result-connection={connection.id}
          d={pathD}
          stroke={musicResultHighlight?.color ?? theme.node.musicResultStroke}
          strokeWidth={7}
          fill='none'
          style={{ ...musicResultHighlight?.connectionStyle, pointerEvents: 'none' }}
        />
      )}
      <path
