...
[Flaq AI](https://flaq.ai/ko/)는 크리에이터, 개발자, 기업을 위한 AI 플랫폼으로, 널리 사용되는 주요 AI 모델을 통합하여
이미지 생성·편집, 동영상 생성, 언어 모델 기능을 제공합니다.

- **높은 동시 처리 성능과 안정성을 갖춘 API** — 통합 AI 생성 API를 통해 모델 기능을 제품과 운영 워크플로에 연결하세요.
- **온라인에서 바로 사용** — 코딩이나 데스크톱 앱 설치 없이 [Flaq AI](https://flaq.ai/ko/)에서 브라우저로 모델과 AI 제작
  도구를 사용할 수 있습니다.
- **모델 탐색과 연동** — [모델 마켓](https://flaq.ai/ko/model-market/)에서 기능을 비교하고
  [API 문서](https://flaq.ai/ko/docs/)를 참고해 통합을 시작하세요.
